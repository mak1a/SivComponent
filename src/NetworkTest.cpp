...
// {
// public:
//     NetworkSystem(const ExitGames::Common::JString& appID, const ExitGames::Common::JString& appVersion);
//     void connect(void);
...
// NetworkSystem::NetworkSystem(const ExitGames::Common::JString& appID, const ExitGames::Common::JString& appVersion)
...
//     NetworkSystem networkLogic(appID, appVersion);
